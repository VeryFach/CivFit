                ...
                {entries.map((entry, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={`flex items-center gap-4 p-4 rounded-[2rem] border-2 transition-all ${isTop3 ? 'bg-white border-brand-dark neo-shadow-lg' : 'bg-white/50 border-brand-dark/10'
                                }`}
                        >
